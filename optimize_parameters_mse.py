import json
from elo_functional import calculate_elo_for_season_mse
import numpy as np
...
k_values = range(1, 31, 3)
s_values = range(1, 31, 3)
...
for k in k_values:
    for s in s_values:
        team_elos, mse = calculate_elo_for_season_mse(team_elos, matches_by_week, k, s)  # You need to implement this function
...
print(f"Best k: {best_k}, Best s: {best_s}, Kendall's tau: {best_mse}")